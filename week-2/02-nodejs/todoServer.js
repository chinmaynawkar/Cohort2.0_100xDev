...
if (fs.existsSync(dataFilePath)) {
  todos = JSON.parse(fs.readFileSync(dataFilePath, 'utf8'));
};
...
app.put('/todos/:id', (req, res) => {
  ...
  const findTodo = todos.find(todo => todo.id === todoIdToUpdate);
  if (findTodo !== -1) {
    todos[todoIdToUpdate] = { ...todos[todoIdToUpdate], ...todoToUpdate };
    saveTodotoFile();
